...
define('confluence/group', [
    ...
    return Control.extend({
        ...
        shiftFocus: function(offset) {
            logger.debug('Group.shiftFocus called with offset: ' + offset);
...
require('confluence/module-exporter').exportModuleAsGlobal('confluence/group', 'AJS.Group');
