...
require('confluence/module-exporter').safeRequire('confluence/aui-overrides', function(AUIOverrides) {
    require('confluence/module-exporter').namespace('AJS.$.debounce', AUIOverrides.debounce);
    require('confluence/module-exporter').namespace('AJS.$.fn.enable', AUIOverrides.enable);
    require('confluence/module-exporter').namespace('AJS.$.fn.disable', AUIOverrides.disable);
});