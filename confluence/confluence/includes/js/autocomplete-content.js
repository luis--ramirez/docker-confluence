...
require('confluence/module-exporter').safeRequire('confluence/autocomplete-content', function(autocompleteContent) {
    ...
    Confluence.Binder.autocompleteConfluenceContent = autocompleteContent.autocompleteConfluenceContent;
