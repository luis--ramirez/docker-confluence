        ...
        $(document).on("click", "#manage-watchers-menu-item, .cw-manage-watchers", function (e) {
            ...
            AJS.safe.ajax({
                ...
                success: function (data) {
                    $dialog.trigger("list-data-retrieved.manage-watchers", { list: pageList, watchers: data.pageWatchers, type: 'page' });
                    $dialog.trigger("list-data-retrieved.manage-watchers", { list: spaceList, watchers: data.spaceWatchers, type: 'space' });
                }
            });
