...
set DISPLAYNAME=Atlassian Confluence.0 %SERVICE_NAME%
...
if "x%1x" == "x--userx" goto runAsUser
set SERVICE_NAME=%1
set DISPLAYNAME=Atlassian Confluence.0 %1
shift
if "x%1x" == "xx" goto checkServiceCmd
goto checkUser
:runAsUser
...
"%EXECUTABLE%" //IS//%SERVICE_NAME% ^
    ...
    --StartParams start ^
    --StopParams stop ^
    --JvmOptions "-Dcatalina.home=%CATALINA_HOME%;-XX:+UseG1GC;-XX:-PrintGCDetails;-XX:+PrintGCTimeStamps;-XX:-PrintTenuringDistribution;-XX:+UseGCLogFileRotation;-XX:NumberOfGCLogFiles=5;-XX:GCLogFileSize=2M;-Xloggc:%CATALINA_HOME%/logs/gc.log;-Djava.awt.headless=true;-Datlassian.plugins.enable.wait=300;-Dcatalina.base=%CATALINA_BASE%;-Djava.endorsed.dirs=%CATALINA_HOME%\endorsed;-Djava.io.tmpdir=%CATALINA_BASE%\temp;-Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager;-Djava.util.logging.config.file=%CATALINA_BASE%\conf\logging.properties" ^
    --JvmMs 1024 ^
    --JvmMx 1024 --Startup auto
